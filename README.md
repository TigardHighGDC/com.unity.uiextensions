...
We do not nor do we claim to own or produce any of the code found in this repository. Simply this is our GitHub save of the free version of Unity's UI Extensions. We use this repository for separating our own code using git submodules.
